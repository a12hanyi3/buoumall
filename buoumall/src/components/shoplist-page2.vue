<template>
<div class="shoplistpage2"  style="overflow:scroll">
...
export default{
	...
	mounted() {
		axios.post("/v2/category/getChildCategory", "categoryId=1003").then(res=>{
		  this.shoplistup =res.data.data;
		});
		axios.post("product/findGuessYouLikeProducts", "memberToken=&categoryId=1003&pageNo=1&pageSize=20").then(res=>{
