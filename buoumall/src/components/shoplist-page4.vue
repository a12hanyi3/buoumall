<template>
<div class="shoplistpage4"  style="overflow:scroll">
...
export default{
	...
	mounted() {
		axios.post("/v2/category/getChildCategory", "categoryId=1883").then(res=>{
		  this.shoplistup =res.data.data;
		});
		axios.post("product/findGuessYouLikeProducts", "memberToken=&categoryId=1883&pageNo=1&pageSize=20").then(res=>{
